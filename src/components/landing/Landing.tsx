    ...
    return (
        <div className="text-white">
            ...
            <div className="relative h-[85vh] flex justify-evenly items-center text-white">
                ...
                <div className="text-white text-4xl absolute translate-x-6 top-[30%] right-[45%]  text-center p-10">
                    <div className="flex flex-col justify-center items-center gap-5">
                        <h1>Create your contest scoreboard</h1>
                        <button className="transition duration-500 w-[10vw] text-xl p-3 border-2 rounded-full hover:bg-white hover:text-black">Create</button>
                    </div>
                </div>
            </div>
